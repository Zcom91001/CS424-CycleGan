...
#SBATCH --output=joseph_cyclegan_replay_buffer_150_lr.out       # Where should the log files go?
...
#SBATCH --job-name=joseph_cyclegan_replay_buffer_150    # Give the job a name
...
srun --ntasks=1 --gres=gpu:1 $HOME/myenv/bin/python3.12 -u src/train_cyclegan_replay_buffer.py --config configs/cyclegan_baseline.yaml --run-name cyclegan_replay_buffer_150_lr