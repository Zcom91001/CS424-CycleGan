        ...
        for element in images.detach():
            ...
            if len(self.buffer) < self.buffer.maxlen:
                ...
                if random.random() > 0.5:
                    idx = random.randint(0, self.buffer.maxlen - 1)
...
def main():
    ...
    for epoch in range(n_epoches):
        for i, (real_A, real_B) in enumerate(trainloader):
            ...
            fake_A_for_D = fake_A_buffer.push_and_pop(fake_A_img)
            loss_fake = criterion_GAN(D_A(fake_A_for_D), fake_A)
            ...
            fake_B_for_D = fake_B_buffer.push_and_pop(fake_B_img)
            loss_fake = criterion_GAN(D_B(fake_B_for_D), fake_B)
